...
import { PROFILE_REGISTRY_KEY, type PlayerProfile, type ProgressGrantResult, type ProgressReward } from './PlayerProfile';
...
export function loadProfileIntoRegistry(scene: SceneWithRegistry): PlayerProfile {
...
export function getProfileFromRegistry(scene: SceneWithRegistry): PlayerProfile {
...
export function selectProfileCharacter(scene: SceneWithRegistry, characterId: string): PlayerProfile {
...
export function grantProfileReward(scene: SceneWithRegistry, reward: ProgressReward): ProgressGrantResult {
